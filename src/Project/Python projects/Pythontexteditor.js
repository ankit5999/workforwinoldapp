...
cx_Freeze.setup(
  ...
  return (
    <>
      <Helmet>
        <title>Python Project: Build a text editor python software</title>
        <meta name="title" content="Python Project: Build a text editor python software" />
        <meta name="description" content="Build python software, a simple text editor with all functionality. This software can be used as a final year project. " canonical="https://workforwin.com/how-to-build-software-in-python" />
        <meta name="keywords" content="python project,python project ideas, python project Github, python project with source code, python project ideas for beginners, python project download, python project source code, workforwin" />
        <meta id="meta-description" name="description" content="Build python software, a simple text editor with all functionality. This software can be used as a final year project. " canonical="https://workforwin.com/how-to-build-software-in-python" />
        <meta id="og-title" property="og:title" content="Python Project: Build a text editor python software" />
        </Helmet>
            ...
            <div className="row">
              ...
              <div className="col-lg-7 order-1 shadow-lg " style={{ paddingRight: "20px", paddingBottom: "5px" }} >
                <h1 style={{ fontSize: "1.7rem", wordSpacing: "5px", paddingTop: "2%", paddingBottom: "15px", borderBottom: "1px solid #ff4a57", color: "#ff4a57", }} >
                  <MenuBookIcon style={{ fontSize: "2.1rem", marginTop: "-5px", color: "#ff4a57", }} /> Python Project: Build a text editor python software </h1>
...
<p>Let's build python software, a simple text editor with all functionality. This software can be used as a final year project. Here you will get the complete source code of this project. To download all required dependency or for downloading zip file 
<NavLink to={{ pathname: "https://github.com/ceoankityadav/Text-editor-" }} target="_blank" className="alert-link" style={{textDecoration:"none"}} > click here </NavLink> .
 </p>
...
<img src="https://1.bp.blogspot.com/-ht0e7yCl0_o/X8oWGMtoOII/AAAAAAAACpw/jPeZ-E7D1Jg3q11YhBre6142zPt1IdWeQCLcBGAsYHQ/s16000/Build%2BText%2BEditor%2BIn%2BPython.webp" className="img-fluid center" alt="" style={{ borderRadius: "10px", padding:"0"}} ></img>
  </div>
</div>
  </div>

<h4 style={{ color: "#302424" }}> Setup.py</h4>
<SyntaxHighlighter language={python} style={prism}>
          {setup}
</SyntaxHighlighter>

<h4 style={{ color: "#302424" }}> Vpad.py</h4>
<SyntaxHighlighter language={python} style={prism}>
          {vpad}
</SyntaxHighlighter>
                ...
                <div className=" col-12 mx-auto mt-5 mb-3">
                  <div className="row">
                    ...
                    <div className="col-lg-11 pt-2">
                      <h3 style={{ fontSize: "1rem", wordSpacing: "5px", paddingBottom: "15px", color: "#000", }} > Auther: <span style={{ color: "gray" }}> @ceoankityadav</span> <br></br>Post on: <span style={{ color: "gray" }}> 5/12/20 </span> </h3>
                    </div>
                    </div>
...
main_application.mainloop()
  ...
  `;
export default Pythontexteditor;
